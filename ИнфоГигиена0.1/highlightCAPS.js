...
jQuery.fn.highlightCAPS = function(pattern) {
    ...
    function innerHighlight(node, pattern) {
        ...
        if (node.nodeType === 3) { // 3 - Text node
            ...
            if (pos >= 0 && node.data.length > 0) { // .* matching "" causes infinite loop
                ...
                spanNode.setAttribute("data-tooltip", "Заглавная буква в интернете использовалась как выражение агрессивного сообщения. Агрессия - одна из удобных эмоций для сообщения недостоверной информации.");
                spanNode.className = 'highlightCAPS'; // set css
