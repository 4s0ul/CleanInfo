...
jQuery.fn.highlightPunctuation = function(pattern) {
    ...
    function innerHighlight(node, pattern) {
        ...
        if (node.nodeType === 3) { // 3 - Text node
            ...
            if (pos >= 0 && node.data.length > 0) { // .* matching "" causes infinite loop
                ...
                spanNode.setAttribute("data-tooltip", "Повторение диакритических знаков - попытка привлечь внимание. Она может свидетельствовать о том, что новость или сообщение предназначены для искусственного распространения информации.");
                spanNode.className = 'highlightPunctuation'; // set css
